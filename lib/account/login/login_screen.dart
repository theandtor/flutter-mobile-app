...
class LoginScreen extends StatelessWidget {
  LoginScreen({Key? key}) : super(key: FlutterLearnAppKeys.mainScreen);
    ...
    return BlocListener<LoginBloc, LoginState>(
      listener: (context, state) {
        if(state.status.isSubmissionSuccess){
          Navigator.pushNamed(context, FlutterLearnAppRoutes.main);
        }
      },
      child: Scaffold(
          appBar: AppBar(
  ...
  Widget register(BuildContext context) {
    return ElevatedButton(
      ...
      onPressed: () => Navigator.pushNamed(context, FlutterLearnAppRoutes.register),
    );
  }
